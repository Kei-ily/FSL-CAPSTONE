...
<body>
    ...
    <div class="modal" id="editModal">
        <div class="modal-content">
            ...
            <div class="form-group">
                ...
                <textarea id="descriptionInput" rows="3" placeholder="Filipino Sign Language Number 1"></textarea>
            </div>
    ...
    <script>
        ...
        const defaultCards = [
            { id: '1', number: '1', imageUrl: 'Images/flashcardNumbers/1.jpg', description: 'Filipino Sign Language Number 1' },
            { id: '2', number: '2', imageUrl: 'Images/flashcardNumbers/2.jpg', description: 'Filipino Sign Language Number 2' },
            { id: '3', number: '3', imageUrl: 'Images/flashcardNumbers/3.jpg', description: 'Filipino Sign Language Number 3' },
            { id: '4', number: '4', imageUrl: 'Images/flashcardNumbers/4.jpg', description: 'Filipino Sign Language Number 4' },
            { id: '5', number: '5', imageUrl: 'Images/flashcardNumbers/5.jpg', description: 'Filipino Sign Language Number 5' },
            { id: '6', number: '6', imageUrl: 'Images/flashcardNumbers/6.jpg', description: 'Filipino Sign Language Number 6' },
            { id: '7', number: '7', imageUrl: 'Images/flashcardNumbers/7.jpg', description: 'Filipino Sign Language Number 7' },
            { id: '8', number: '8', imageUrl: 'Images/flashcardNumbers/8.jpg', description: 'Filipino Sign Language Number 8' },
            { id: '9', number: '9', imageUrl: 'Images/flashcardNumbers/9.jpg', description: 'Filipino Sign Language Number 9' },
            { id: '10', number: '0', imageUrl: 'Images/flashcardNumbers/0.jpg', description: 'Filipino Sign Language Number 0' }
        ];
        ...
        function loadCards() {
            const savedCards = localStorage.getItem('fsl-cards-numbers');
            cards = savedCards ? JSON.parse(savedCards) : defaultCards;
        }

        // Save cards to localStorage
        function saveCards() {
            localStorage.setItem('fsl-cards-numbers', JSON.stringify(cards));
        }
        ...
        function renderFlashcard() {
            ...
            document.getElementById('flashcardNumber').textContent = card.number;
        ...
        function openEditModal(cardId) {
            ...
            document.getElementById('modalTitle').textContent = `Edit Card - Number ${card.number}`;
            document.getElementById('imageUrlInput').value = card.imageUrl;
             document.getElementById('imageUrlInput').value = `Images/flashcardNumbers/${card.number}.jpg`;
